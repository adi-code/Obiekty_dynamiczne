...
void OmniOptOptimizer::assign_rank_and_crowding_distance (OmniOptOptimizer::population *new_pop)
{
    int flag;
    int i;
    int end;
    ...
    do
    {
        if (orig->child->child == NULL)
        {
            ...
            new_pop->ind[orig->child->index].crowd_dist = large;
            break;
        }
        temp1 = orig->child;
        ...
        do
        {
            ...
            do
            {
                ...
                flag = check_loose_dominance (&(new_pop->ind[temp1->index]), &(new_pop->ind[temp2->index]));
                if (flag == 1)
                {
